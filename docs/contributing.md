...
Contributions are welcome. `go-ruby-rexml/rexml` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-rexml/rexml`](https://github.com/go-ruby-rexml/rexml). This documentation site is in
[`github.com/go-ruby-rexml/docs`](https://github.com/go-ruby-rexml/docs). Start from the
